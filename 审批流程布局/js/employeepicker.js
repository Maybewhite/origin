        ...
        render: function () {
            ...
            var tpl = '<div style="width:220px; height:388px; border-right:1px solid #eee; overflow-x: hidden; overflow-y: auto; float:left;">\
						...
						<div style="width:568px; height:388px; user-select:none; overflow-x: hidden; overflow-y: auto; float:left;">\
							<div style="padding:15px 10px 0;"><div style="color:#999; text-align:center;">鈬� 鐐瑰嚮宸﹁竟閮ㄩ棬绛涢€夊憳宸ワ紝鎴栬€呯偣鍑讳笅闈㈠瓧姣嶇瓫閫�</div><div id="letterBtn" style="color:#999; text-align:center;">' + letterTem + '</div></div>\
            ...
            if (me.settings.type == 0) {
                ...
                for (var a = 0; a < me.settings.ids.length; a++) {
                    if (me.settings.fixedid == me.settings.ids[a] && me.settings.fixedid != 0) {
                        ...
                        select_tags += '<span class="layui-tags-span">' + me.settings.names[a] + '<i data-index="' + a + '" data-id="' + me.settings.ids[a] + '" class="layui-icon layui-tags-close">醼�</i></span>';
                    }
                }
            }
            return select_tags;
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        ...
                                        if (dataList.length > 0) {
                                            ...
                                            $('#employee').html('<div style="color:#999; text-align:center;">鏆傛棤鍛樺伐</div>');
                                        }
                                    }
                                })
                            });
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        ...
                                        if (dataList.length > 0) {
                                            ...
                                            if (tagsItem == '') {
                                                tagsItem = '<div style="color:#999; text-align:center;">鏆傛棤鍛樺伐</div>';
                                            }
                                            $('#employee').html(tagsItem);
                                        } else {
                                            $('#employee').html('<div style="color:#999; text-align:center;">鏆傛棤鍛樺伐</div>');
